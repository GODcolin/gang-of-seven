...
public class LogAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.nyanner.govii.elementary.annotation.Log)")
...
//            LoginUser loginUser = SpringUtils.getBean(TokenService.class).getLoginUser(ServletUtils.getRequest());
            ...
            String username = securityAuditorAware.getCurrentAuditorName().orElseThrow();
            // *========数据库日志=========*//
